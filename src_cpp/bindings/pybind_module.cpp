...
PYBIND11_MODULE(_engine, m) {
    ...
    m.def("simulate_schwarzschild_equatorial_rk4", schw_fn,
    ...
    using KerrFn = relorbit::TrajectoryKerrEq (*)(
        double, double, double, double, double, double, double, double, double,
        const relorbit::SolverCfg&, double, double
    );
    KerrFn kerr_fn = &relorbit::simulate_kerr_equatorial_rk4;

    m.def("simulate_kerr_equatorial_rk4", kerr_fn,
